/* src/config/litecloud-config.h.  Generated from litecloud-config.h.in by configure.  */
/* src/config/litecloud-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef LTCL_CONFIG_H

#define LTCL_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.litecloud.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Litecloud Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Litecloud Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "litecloud"
